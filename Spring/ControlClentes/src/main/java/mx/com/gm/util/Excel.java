...
import static mx.com.gm.util.Excel_controller.compararArchivosExcel;
import static mx.com.gm.util.Excel_controller.crearArchivoExcel;
import static mx.com.gm.util.Excel_controller.imp;
import static mx.com.gm.util.Excel_controller.leerArchivoExcel;
import java.io.File;
...
public class Excel {
    ...
    public void main() throws IOException {
        File f =new File("C:/Users/ACER/Desktop/Nuevo Hoja de cálculo de Microsoft Excel.xlsx");
        if (f.exists()) {
